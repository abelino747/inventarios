document.addEventListener('DOMContentLoaded', function () {
    ...
    function mostrarFormularioActualizar(row) {
        ...
        document.getElementById("nitmodificar").value = row.cells[1].innerHTML;
        document.getElementById("razonsocialmodificar").value = row.cells[2].innerHTML;
        document.getElementById("direccionmodificar").value = row.cells[3].innerHTML;
        document.getElementById("encargadomodificar").value = row.cells[4].innerHTML;
        document.getElementById("telefonomodificar").value = row.cells[5].innerHTML;
        document.getElementById("correomodificar").value = row.cells[6].innerHTML;
        document.getElementById("diaspedidosmodificar").value = row.cells[7].innerHTML;
        document.getElementById("diasentregamodificar").value = row.cells[8].innerHTML;
    ...
    function mostrarFormularioEliminar(row) {
        ...
        document.getElementById("niteliminar").value = row.cells[1].innerHTML;
        document.getElementById("razonsocialeliminar").value = row.cells[2].innerHTML;
        document.getElementById("direccioneliminar").value = row.cells[3].innerHTML;
        document.getElementById("encargadoeliminar").value = row.cells[4].innerHTML;
        document.getElementById("telefonoeliminar").value = row.cells[5].innerHTML;
        document.getElementById("correoeliminar").value = row.cells[6].innerHTML;
        document.getElementById("diaspedidoseliminar").value = row.cells[7].innerHTML;
        document.getElementById("diasentregaeliminar").value = row.cells[8].innerHTML;
